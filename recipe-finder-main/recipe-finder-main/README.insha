...
The backend for the Recipe Finder web application is built with Node.js and Express.js, providing a robust API for managing user data and recipes. This API interacts with a MongoDB database to handle user authentication and recipe storage. You can find the source code for the backend [here](https://github.com/InshaQuamar/recipe-finder-backend).

## Demo

Explore the live demo: [Recipe Finder](https://github.com/InshaQuamar/)
